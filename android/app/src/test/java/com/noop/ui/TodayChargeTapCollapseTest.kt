 ...
 * hero (#205), and the metrics-grid overflow cap (S5). These mirror the Swift TodayView.readinessWord /
 * metricsCollapsedCap EXACTLY, so a drift in either platform's labels/numbers fails here.
 */
